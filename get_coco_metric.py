...
def parse_opt():
    ...
    parser.add_argument('--anno_json', type=str,
                        default=r'F:\visdrone\VisDrone2019-DET-val\data.json',
                        help='training model path')
    parser.add_argument('--pred_json', type=str, default=r'C:\Users\ljw\Desktop\UAV-DETR-main\runs\val\exp11\predictions.json',
                        help='data yaml path')
