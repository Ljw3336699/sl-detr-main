...
if __name__ == '__main__':
    # anno_json = r'F:\visdrone\VisDrone2019-DET-val\data.json'
    anno_json = r'F:\Mydataset\visdrone\output\VisDrone2019-DET_val_coco_start.json'
    pred_json = r'C:\Users\ljw\Desktop\UAV-DETR-main\runs\val\exp4\predictions.json'
