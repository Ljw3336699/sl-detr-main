...
from ultralytics.utils.loss import (
    ...
    v8DetectionLoss,
    v8PoseLoss,
    v8SegmentationLoss, E2EDetectLoss, v8OBBLoss,
)
...
from ultralytics.nn.mc_modules import *
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8m.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
